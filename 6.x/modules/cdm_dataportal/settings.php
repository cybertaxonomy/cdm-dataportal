...
function cdm_dataportal_menu_admin(&$items){
    ...
    $items['admin/settings/cdm_dataportal'] = array(
    ...
    $items['admin/settings/cdm_dataportal/general'] = array(      
      'title' => 'General',
      'description' => 'Setting for the CDM DataPortal',
      'access arguments' => array('administer cdm_dataportal'),
      'page callback' => 'drupal_get_form',
    ...
    $items['admin/settings/cdm_dataportal/cachesite'] = array(
      'title' => 'Cache',
      'description' => 'Cache',
      'access arguments' => array('administer cdm_dataportal'),
      'page callback' => 'drupal_get_form',
    ...
    $items['admin/settings/cdm_dataportal/geo'] = array(
      'title' => 'Geo & Map',
      'description' => 'Geo & Map',
      'access arguments' => array('administer cdm_dataportal'),
      'page callback' => 'drupal_get_form',
    ...
    $items['admin/settings/cdm_dataportal/layout'] = array(
      'title' => 'Layout',
    ...
    $items['admin/settings/cdm_dataportal/layout/taxon'] = array(
      'title' => 'Taxon',
      'description' => 'Configure and adjust the layout of your DataPortal ',
      'access arguments' => array('administer cdm_dataportal'),
      'page callback' => 'drupal_get_form',
...
*/
    $items['admin/settings/cdm_dataportal/layout/search'] = array(
      'title' => 'Search',
      'description' => 'Configure and adjust the layout of your DataPortal ',
      'access arguments' => array('administer cdm_dataportal'),
      'page callback' => 'drupal_get_form',
    ...
    $items['admin/settings/cdm_dataportal/layout/media'] = array(
      'title' => 'Media',
      'description' => 'Configure and adjust the layout of your DataPortal ',
      'access arguments' => array('administer cdm_dataportal'),
      'page callback' => 'drupal_get_form',
...
/* ====== SYNONYMY ====== */
 ...
 $form['synonymy'][CDM_DATAPORTAL_DISPLAY_TAXON_RELATIONSHIPS] = array(
  ...
  //@WA: undefined constant _cdm_relationship_type_term_label_callback
