 ...
 *
 * This file controls the page that is displayed when the site is in "maintenance mode" 
 * but the database connection and database are still functioning correctly
 *
