...
(function($) {
  ...
  $.fn.lightBox = function(settings) {
    ...
    function _initialize() {
      // This, in this context, refer to object (link) which the user
      // have clicked.
    ...
    function _resize_container_image_box(intImageWidth,intImageHeight) {
      ...
      var myWidth = $(window).width() -500;
      if((settings.adjustToWindow == true && settings.adjustToWindow != null)  && (intImageWidth > myWidth || intImageHeight > myHeight)) {
        // Get the height and width of the window to resize the image
        // appropriately, Height is at -150 to compensate for various padding
        // and borders.
        ...
        var scale = myHeight/intImageHeight;
    ...
    // Return the jQuery object for chaining. The unbind method is used to avoid
    // click conflict when the plugin is called more than once.
