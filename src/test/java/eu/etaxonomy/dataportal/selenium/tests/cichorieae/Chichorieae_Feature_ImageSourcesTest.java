...
public class Chichorieae_Feature_ImageSourcesTest extends CdmDataPortalTestBase {
    ...
    public void pilosella_anchusoides() throws MalformedURLException {
        ...
        assertEquals("A. Gottschlich, G. 2009: Die Gattung Hieracium (Compositae) in der Region Abruzzen (Italien). – Stapfia 89 (as Hieracium anchusoides (Arv.-Touv.) St.-Lag.)", imageSourcesBlock.getFootNote(0).getText());
    }
