...
public class FootnoteTest extends CdmDataPortalTestBase {
    ...
    public void namePageFieldUnitAnnotation() throws MalformedURLException{
        ...
        assertEquals("Nodosilinea radiophila Heidari & Hauer in Fottea 18(2): 142. fig. 5C, D. 1 Nov 2018.Registration: http://testbank.org/100004, 2024-03-20, nom. illeg." + titleSuffix, driver.getTitle());
