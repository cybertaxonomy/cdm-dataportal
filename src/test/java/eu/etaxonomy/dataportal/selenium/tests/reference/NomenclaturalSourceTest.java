...
public class NomenclaturalSourceTest extends CdmDataPortalTestBase{
    ...
    public void testNomenclaturalReference() {
        ...
        assertEquals("Nepenthes gracilis Korth., Verh. Nat. Gesch. Ned. Bezitt., Bot. 19: 22, t. 1 & 4. 1840 [& (J. T. K.) Spock & Scotty in Bot. Jahrb. Sol. 211: 591. 21941,2], [some typification note]. wfo-0001250151", acceptedName.getText());
